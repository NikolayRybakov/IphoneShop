        ...
        <div className="iphone">
            <div className="container">
                ...
                <div className="iphone__inner">
                    ...
                    <div className="iphone__item">
                        <img className="iphone__img iphone_disabled" src={image4} alt="Apple Iphone-13" />
                    </div>
                    <div className="iphone__item">
                        <img className="iphone__img iphone_disabled" src={image5} alt="Apple Iphone-13" />
                    </div>
                </div>
            </div>
        </div>
