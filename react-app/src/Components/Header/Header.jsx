                ...
                <div className="header__inner">
                    ...
                    <div className="header__block">
                        <div className="header__heart">
                            <svg className="header__heart-svg" width="43" height="35" viewBox="0 0 28 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="header__basket">
                            <svg className="header__basket-svg" width="42" height="41" viewBox="0 0 42 41" fill="none" xmlns="http://www.w3.org/2000/svg">
